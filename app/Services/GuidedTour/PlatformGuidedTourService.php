    ...
    public function entryPayload(?User $user): array
    {
        ...
        if (! $user) {
            return [
                ...
                'progress_text' => sprintf('%d etapes interactives reelles', $totalSteps),
    ...
    private function stepBlueprints(): array
    {
        return [
            ...
            2 => [
                ...
                'summary' => 'Le dashboard centralise les grands modules de la plateforme.',
                'description' => 'C est le point de passage naturel pour repartir vers les matchs, les missions, les clips, les cadeaux et le reste sans chercher partout.',
                ...
                'fallback_body' => 'Meme si la grille ciblee change, gardez le reflexe de passer par le dashboard pour vous orienter.',
            ],
            3 => [
                'id' => 'matches-overview',
