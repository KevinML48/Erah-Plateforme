    ...
    private function articles(): array
    {
        return [
            ...
            [
                ...
                'summary' => 'La page Supporter sert a comparer les formules et activer le programme.',
                'body' => "Le programme supporter permet de soutenir ERAH tout en debloquant un badge visible, des missions reservees, des reactions premium, des votes clips et d autres avantages communautaires.\n\nPour l activer, il faut ouvrir la page Supporter, comparer les formules disponibles puis lancer le checkout. La facturation et l activation sont ensuite gerees via le parcours prevu sur la plateforme.\n\nSi vous etes deja membre, la console supporter vous aide ensuite a suivre votre statut, vos avantages et vos missions exclusives.",
            ...
            [
                ...
                'slug' => 'peut-on-parier-sur-un-match',
                'summary' => 'Oui, quand un match dispose d un marche ouvert et que le verrouillage n est pas passe.',
                'body' => "Oui, si la fonctionnalite de pari est ouverte sur le match concerne. Depuis la page Matchs, ouvrez la fiche de la rencontre pour verifier les selections disponibles, l heure de cloture et votre mise en points.\n\nLe pari est possible tant que le match n est pas verrouille et qu au moins un marche reste ouvert. Une fois le lock passe, vous ne pouvez plus miser sur cette rencontre.\n\nSi aucun pari n est ouvert, cela signifie qu aucun match eligible n est disponible pour le moment ou que les marches sont deja fermes. Vous pouvez alors revenir plus tard sur la page Matchs pour verifier les prochaines ouvertures.",
                'short_answer' => 'Oui, mais seulement sur un match avec un marche ouvert avant le verrouillage. Sinon aucun pari n est disponible.',
                'keywords' => ['peut on parier', 'match', 'pari', 'verrouillage', 'marche'],
                'is_featured' => true,
                'is_faq' => true,
                'sort_order' => 15,
                'cta_label' => 'Voir les matchs',
