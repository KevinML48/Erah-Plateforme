@props([
    ...
    'nextRankName' => null,
    'totalPlatformPoints' => null,
])

<div {{ $attributes->merge(['class' => 'premium-card premium-readable card-3d animate-fade-up p-5 md:p-6']) }}>
    ...
    <div class="mt-4">
        ...
        <div class="h-2 w-full rounded-full bg-gray-200 dark:bg-gray-800">
            <div class="h-2 rounded-full bg-brand-500" style="width: {{ max(2, (int) $progressToNextRank) }}%"></div>
        </div>
    </div>
</div>
