...
@section('title', 'Challengers VCL 2026 | ERAH Esport')

@section('meta_description', 'Revivez la participation d’ERAH Esport à la Challengers VCL 2026 : tournois, performances et moments forts au plus grand festival gaming de France.')

@section('meta_keywords', 'Challengers VCL 2026, ERAH Esport Challengers VCL, tournoi esport Challengers VCL, LAN France 2025, compétition esport, festival gaming France, esport national')
...
<div id="page-header" class="ph-full ph-full-m ph-cap-xlg ph-center ph-image-parallax ph-caption-parallax">
				...
				<div class="ph-image ph-image-cover-2">
					<div class="ph-image-inner">
						<img src="/template/assets/img/galerie/challengers_valorant.jpg" alt="Image">
					</div>
				</div>
				...
				<div class="page-header-inner tt-wrap">
					...
					<div class="ph-caption">
						<div class="ph-caption-inner">
							<h1 class="ph-caption-title">Challengers VCL<br> 2026</h1>
                                    ...
                                    <div class="tt-row">
                                        <div class="tt-col-lg-9">
                                            ...
                                            <div class="tt-anim-fadeinup">
												<p>ERAH Esport a réalisé un exploit remarquable en remportant les Up&Down sans concéder le moindre match. Cette performance exceptionnelle nous a permis de nous qualifier pour la VCL 2026, l'élite du circuit Valorant français. Avec un parcours sans défaite, notre équipe a prouvé sa domination et sa détermination à se hisser parmi les meilleures équipes nationales.</p>
                                            </div>
										...
										<div class="tt-project-info-list tt-anim-fadeinup">
											<ul>
												<li>
													...
													<div class="pi-list-cont">Challengers VCL 2026</div>
												</li>
												<li>
												...
												<li>
													...
													<div class="pi-list-cont"><a
															href="https://x.com/ErahEsport/status/1986192123939479563?s=20"
  ...
  <div class="tt-sticker-scroller">
    ...
    <div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
      <figure>
        <a href="/template/assets/img/galerie/poster_final-1.png" class="tt-image-link"
          data-cursor="View" data-fancybox="gallery-746091"
          data-caption="Équipe Valorant">
          <img src="/template/assets/img/galerie/poster_final-1.png"
    ...
    <div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
      <figure>
        <a href="/template/assets/img/galerie/qualification-vcl-clip.mp4" class="tt-image-link"
          data-cursor="View" data-fancybox="gallery-746091"
          data-caption="Qualification Challengers VCL 2026">
          <div class="video-full-container">
            <video src="/template/assets/img/galerie/qualification-vcl-clip.mp4" autoplay loop muted playsinline class="video-full"></video>
          </div>
        </a>
        <figcaption>
          Qualification Challengers VCL 2026
        </figcaption>
      </figure>
    </div>
    ...
    <div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
      <figure>
        <a href="/template/assets/img/galerie/tommy-clip.mp4" class="tt-image-link"
          data-cursor="View" data-fancybox="gallery-746091"
          data-caption="Clip Up&Down">
          <div class="video-full-container">
            <video src="/template/assets/img/galerie/tommy-clip.mp4" autoplay loop muted playsinline class="video-full"></video>
          </div>
        </a>
        <figcaption>
          Clip Up&Down
    ...
    <div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
      <figure>
        <a href="/template/assets/img/galerie/ace-up-down-2025.mp4" class="tt-image-link"
          data-cursor="View" data-fancybox="gallery-746091"
          data-caption="Qualification Challengers VCL 2026">
          <div class="video-full-container">
            <video src="/template/assets/img/galerie/ace-up-down-2025.mp4" autoplay loop muted playsinline class="video-full"></video>
          </div>
        </a>
        <figcaption>
          Qualification Challengers VCL 2026
    ...
    <div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
      <figure>
        <a href="/template/assets/img/galerie/bracket-up-down.jpg" class="tt-image-link"
          data-cursor="View" data-fancybox="gallery-746091"
          data-caption="Bracket Up&Down">
								...
								<div class="tt-row">
									...
									<div class="tt-col-md-5 tt-align-self-center">
										...
										<div class="tt-next-project-item">
											<a href="/lyon-esport-2025" class="tt-npi-image" data-cursor="Lyon Esport 2025">
											...
											<div class="tt-npi-caption">
												<div class="tt-npi-title">
													<a href="/gamers-assembly-2024">Lyon Esport 2025</a>
												</div>
