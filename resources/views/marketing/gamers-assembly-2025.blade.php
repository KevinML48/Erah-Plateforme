...
@section('title', 'Gamers Assembly 2025 | ERAH Esport')

@section('meta_description', 'ERAH Esport participe à la Gamers Assembly 2025 : compétitions, rencontres et passion esport au plus grand festival gaming de France.')

@section('meta_keywords', 'Gamers Assembly 2025, ERAH Esport Gamers Assembly, tournoi esport Poitiers, LAN France 2025, compétition esport, festival gaming France, esport national')
...
<div id="page-header" class="ph-full ph-full-m ph-cap-xlg ph-center ph-image-parallax ph-caption-parallax">
				...
				<div class="ph-image ph-image-cover-2">
					<div class="ph-image-inner">
						<img src="/template/assets/img/galerie/gamers-assembly-2025-1.webp" alt="Image">
					</div>
				</div>
				...
				<div class="page-header-inner tt-wrap">
					...
					<div class="ph-caption">
						<div class="ph-caption-inner">
							<h1 class="ph-caption-title">Gamers Assembly<br> 2025</h1>
						...
						<div class="tt-row">
							<div class="tt-col-lg-9">
								...
								<div class="tt-anim-fadeinup">
									<p>Top 7 à la Gamers Assembly 2025&nbsp;! Nous sommes fiers de cette performance qui
										reflète le travail et la progression constante de notre club. Ce résultat
										confirme que nous sommes sur la bonne voie et nous motive à viser encore plus
										haut pour les prochaines compétitions.</p>
								</div>
										...
										<div class="tt-project-info-list tt-anim-fadeinup">
											<ul>
												<li>
													...
													<div class="pi-list-cont">Gamers Assembly 2025</div>
												</li>
												<li>
												...
												<li>
													...
													<div class="pi-list-cont"><a
															href="https://x.com/ErahEsport/status/1913898345698930910"
								...
								<div class="tt-col-lg-9 padding-right-lg-3-p">
									...
									<div class="tt-sticker-scroller">
										...
										<div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
											<figure>
												<a href="/template/assets/img/galerie/gamers-assembly-2025-1.webp" class="tt-image-link"
										...
										<div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
											<figure>
												<a href="/template/assets/img/galerie/gamers-assembly-2025-2.webp"
										...
										<div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
											<figure>
												<a href="https://youtu.be/j0A9xzsZ7hc" class="tt-image-link"
													data-cursor="View" data-fancybox="gallery-746091"
													data-caption="Interview GA 2025">
													<img src="/template/assets/img/galerie/interview-GA-2025.webp"
														class="tt-anim-zoomin" loading="lazy" alt="Image">
												</a>
												<figcaption>
													Interview GA 2025
										...
										<div class="tt-image tti-border-radius tti-landscape margin-bottom-40">
											<figure>
												<a href="/template/assets/img/galerie/moment-ga-2025.mp4" class="tt-image-link"
													data-cursor="View" data-fancybox="gallery-746091"
													data-caption="GA 2025">
													<div class="video-full-container">
														<video src="/template/assets/img/galerie/moment-ga-2025.mp4" autoplay loop muted playsinline class="video-full">
</video>
					...
					<div class="tt-section padding-bottom-xlg-160">
						<div class="tt-section-inner tt-wrap">
							...
							<div class="text-xlg max-width-1000 tt-text-reveal">
								ERAH Esport est fier d’avoir participé à la Gamers Assembly 2025. Cet événement majeur
								du gaming français restera un moment fort pour notre équipe, mêlant compétition, passion
								...
								<div class="tt-row">
									...
									<div class="tt-col-md-5 tt-align-self-center">
										...
										<div class="tt-next-project-item">
											<a href="/hoplan-2025" class="tt-npi-image" data-cursor="HopLan 2025">
											...
											<div class="tt-npi-caption">
												<div class="tt-npi-title">
													<a href="/hoplan-2025">HopLan 2025</a>
												</div>
