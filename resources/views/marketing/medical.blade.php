...
@section('title', 'Médical | ERAH Esport')

@section('meta_description', 'Découvrez l’approche médicale et bien-être d’ERAH Esport : prévention santé, ergonomie, accompagnement et sensibilisation pour les joueurs et bénévoles.')

@section('meta_keywords', 'ERAH Esport médical, santé esport, bien-être gaming, prévention joueurs, ergonomie esport, accompagnement santé, sensibilisation esport, gaming responsable')
...
<div id="page-header"
				...
				<div class="page-header-inner tt-wrap">
					...
					<div class="ph-caption">
						<div class="ph-caption-inner">
							<h2 class="ph-caption-subtitle">Notre équipe médicale</h2>
							<h1 class="ph-caption-title">ERAH Esport</h1>
							<div class="ph-caption-description max-width-700">
								Découvrez l’équipe médicale d’ERAH Esport, dédiée à assurer le bien-être et la santé
								optimale de nos joueurs et talents.
							</div>
						</div>
					</div>
				...
				<div class="page-header-inner ph-mask">
					<div class="ph-mask-inner tt-wrap">
						...
						<div class="ph-caption">
							<div class="ph-caption-inner">
								<h2 class="ph-caption-subtitle">Soin et prévention</h2>
								<h1 class="ph-caption-title">Nos valeurs</h1>
								<div class="ph-caption-description max-width-700">
									Professionnalisme, vigilance et engagement : notre équipe médicale veille à la
									santé, la récupération et la performance de chaque membre d’ERAH Esport.
								</div>
							</div>
						</div>
			...
			<div class="ph-social">
				<ul>
					...
					<li><a href="https://x.com/ErahEsport" class="tt-magnetic-item" target="_blank" rel="noopener"><i
				...
				<div class="tt-section-inner">
					...
					<div class="tt-portfolio-preview-list tt-ppli-portrait tt-ppli-hover">
						<div class="tt-ppl-items-list">
							...
							<a href="https://x.com/InfinityUP2" class="tt-ppl-item" target="_blank" rel="noopener">
								<div class="tt-ppli-preview">
									<div class="tt-ppli-preview-image">

										<img src="/template/assets/img/staffs-erah/infinity-up.jpg" alt="Image">
									</div>
								</div>
									...
									<div class="tt-ppl-item-holder">
										...
										<div class="tt-ppli-col tt-ppli-col-caption">
											<div class="tt-ppli-caption">
												<h2 class="tt-ppli-title">InfinityUP</h2>
												<div class="tt-ppli-categories">
													<div class="tt-ppli-category">Head of Performances</div>
										...
										<div class="tt-ppli-col tt-ppli-col-info tt-justify-content-md-end">
											<div class="tt-ppli-info">
												Kiné/Coach perf spécialisé E-sport
											</div>
										</div>
									</div>
								</div>
					...
					<div class="tt-portfolio-preview-list tt-ppli-portrait tt-ppli-hover">
						<div class="tt-ppl-items-list">
							...
							<a href="https://x.com/petitgeniie" class="tt-ppl-item" target="_blank" rel="noopener">
								<div class="tt-ppli-preview">
									<div class="tt-ppli-preview-image">

										<img src="/template/assets/img/staffs-erah/petitgenie.png" alt="Image">
									</div>
								</div>
								...
								<div class="tt-ppl-item-inner">
									<div class="tt-ppl-item-holder">
										...
										<div class="tt-ppli-col tt-ppli-col-caption">
											<div class="tt-ppli-caption">
												<h2 class="tt-ppli-title">PetitGeniie</h2>
												<div class="tt-ppli-categories">
													<div class="tt-ppli-category">Support</div>
