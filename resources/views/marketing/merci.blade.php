...
@section('title', 'Message reçu | ERAH Esport')

@section('meta_description', 'Merci ! Votre message a été envoyé à ERAH Esport. Vous recevrez une réponse par email sous 24 heures.')

@section('meta_keywords', 'ERAH Esport, message envoyé, contact, formulaire, confirmation, club gaming, esports, événements gaming')
    ...
    <div class="tt-section no-padding">
        <div class="tt-section-inner tt-wrap">
            ...
            <div class="tt-404-error">
                <h2 class="tt-404-error-subtitle">Merci !</h2>
                <h1 class="tt-404-error-title">Message envoyé</h1>
                <div class="tt-404-error-description">
