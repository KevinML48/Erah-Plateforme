                ...
                <div class="adm-shell">
                    ...
                    <section class="adm-surface">
                        <div class="adm-kpi-grid">
                            ...
                            <article class="adm-kpi-card"><strong>{{ (int) ($overview['missions_complèted_today'] ?? 0) }}</strong><span>Completees aujourd hui</span></article>
                        ...
                        <div class="adm-row-actions" style="margin-top:14px;">
                            <form method="POST" action="{{ route('missions.generate.daily') }}">@csrf<button type="submit" class="tt-btn tt-btn-secondary tt-magnetic-item"><span data-hover="Quotidiennes">Regénérer les quotidiennes</span></button></form>
                            <form method="POST" action="{{ route('missions.generate.weekly') }}">@csrf<button type="submit" class="tt-btn tt-btn-primary tt-magnetic-item"><span data-hover="Hebdomadaires">Regénérer les hebdomadaires</span></button></form>
                            <form method="POST" action="{{ route('missions.generate.event-window') }}">@csrf<button type="submit" class="tt-btn tt-btn-outline tt-magnetic-item"><span data-hover="Fenetre">Regénérer la fenetre evenement</span></button></form>
                    ...
                    <section class="adm-surface">
                        ...
                        <form method="POST" action="{{ route('admin.missions.store') }}" class="tt-form tt-form-creative adm-form">
                            ...
                            <div class="adm-form-grid-4">
                                ...
                                <div class="tt-form-group adm-col-span-2"><label>Description détaillée</label><textarea class="tt-form-control" name="description" rows="2">{{ old('description') }}</textarea></div>
                                ...
                                <div class="tt-form-group"><div class="tt-form-check"><input type="checkbox" id="mission_is_discovery" name="is_discovery" value="1" @checked(old('is_discovery'))><label for="mission_is_discovery">Mise en avant découverte</label></div></div>
                                    ...
                                    <article class="adm-mission-card">
                                        ...
                                        <form method="POST" action="{{ route('admin.missions.update', $template->id) }}" class="tt-form tt-form-creative adm-form">
                                            ...
                                            <div class="adm-form-grid-4">
                                                ...
                                                <div class="tt-form-group"><div class="tt-form-check"><input type="checkbox" id="mission_discovery_{{ $template->id }}" name="is_discovery" value="1" {{ $template->is_discovery ? 'checked' : '' }}><label for="mission_discovery_{{ $template->id }}">Mise en avant découverte</label></div></div>
