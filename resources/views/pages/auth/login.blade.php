...
@section('title', 'Connexion | ERAH Plateforme')
@section('meta_description', 'Connectez-vous a votre compte ERAH pour acceder a la plateforme.')
            ...
            <div class="ph-mask-inner tt-wrap">
                <div class="ph-caption">
                    <div class="ph-caption-inner">
                        ...
                        <h1 class="ph-caption-title">Connexion</h1>
                        <div class="ph-caption-description max-width-700">
                            Votre espace personnel est disponible apres authentification.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tt-col-xl-5 padding-right-xlg-40 margin-bottom-60 no-margin-xlg-bottom">
                        ...
                        <div class="tt-form-group">
                            <a href="{{ url('/auth/google/redirect') }}" class="tt-btn tt-btn-secondary tt-magnetic-item">
                                <span data-hover="Connexion Google">Connexion Google</span>
                            </a>
                        </div>

                        <div class="tt-form-group">
                            <a href="{{ url('/auth/discord/redirect') }}" class="tt-btn tt-btn-outline tt-magnetic-item">
                                <span data-hover="Connexion Discord">Connexion Discord</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="tt-col-xl-7 padding-left-xlg-40">
                        <form method="POST" action="{{ route('auth.login') }}" class="tt-form tt-form-creative tt-form-lg">
                            ...
                            <div class="tt-form-text margin-top-20">
                                <a href="{{ route('register') }}" class="tt-link">Creer un compte</a>
                                &nbsp;|&nbsp;
                                <a href="{{ route('password.request') }}" class="tt-link">Mot de passe oublie ?</a>
                            </div>
                        </form>
                    </div>
                </div>
